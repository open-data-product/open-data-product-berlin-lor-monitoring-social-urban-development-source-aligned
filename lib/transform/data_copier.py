...
def get_results_file_name(subdir, source_file_name):
    ...
    if (
        source_file_name == "2-2-indexind_anteile_bzr_mss2019.xlsx"
        and subdir == "berlin-lor-monitoring-social-urban-development-2017-00"
    ):
    ...
    if (
        source_file_name == "2-2-indexind_anteile_bzr_mss2019.xlsx"
        and subdir == "berlin-lor-monitoring-social-urban-development-2019-00"
    ):
    ...
    if (
        source_file_name
        == "tabelle_1_gesamtindex_soziale_ungleichheit_sdi_mss_2021.xlsx"
    ):
        return "berlin-lor-monitoring-social-urban-development-2021-00-1.xlsx"
    if (
        source_file_name
        == "tabelle_2-1_index-indikatoren_anteilswerte_auf_planungsraum-ebene_mss_2021.xlsx"
    ):
        return "berlin-lor-monitoring-social-urban-development-2021-00-2-1.xlsx"
    if (
        source_file_name
        == "tabelle_2-2_index-indikatoren_anteilswerte_auf_bezirksregionen-ebene_mss_2021.xlsx"
    ):
        return "berlin-lor-monitoring-social-urban-development-2021-00-2-2.xlsx"
    if (
        source_file_name
        == "tabelle_2-3_index-indikatoren_auf_ebene_der_bezirke_mss_2021.xlsx"
    ):
    ...
    if (
        source_file_name
        == "tabelle_4-3_kontext-indikatoren_anteile_bezirke_mss_2021.xlsx"
    ):
        return "berlin-lor-monitoring-social-urban-development-2021-00-4-3.xlsx"
    if (
        source_file_name
        == "tabelle_4-1-1_kontext-indikatoren_anteile_plr_mss_2021.xlsx"
    ):
        return "berlin-lor-monitoring-social-urban-development-2021-00-4-1-1.xlsx"
    if (
        source_file_name
        == "tabelle_4-2-1_kontext-indikatoren_anteile_bzr_mss_2021.xlsx"
    ):
        return "berlin-lor-monitoring-social-urban-development-2021-00-4-2-1.xlsx"
    if (
        source_file_name
        == "tabelle_4-3-1_kontext-indikatoren_anteile_bezirke_mss_2021.xlsx"
    ):
